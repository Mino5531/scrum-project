<?php
	...
	$qAusgabe = " SELECT `Datum`, `Betrag`, `GameID` FROM `paymenthistory` WHERE UserID = $SESSION_userID  ORDER BY `Datum` DESC";
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-1">Payment history</h3>
                    <?php
						...
						echo "<TABLE border=1 cellpadding=10 cellspacing=0>
							...
							while($row = mysqli_fetch_assoc($result)) {
							  ...
							  for($i = 0; $i <4; ++$i) {
								...
								if ($temp == "GameID")
								  {	
									  $qSpiel = "SELECT `Name` FROM `game` WHERE GameID= '$row[$temp]'";
									  $resSpiel= mysqli_query($mysqlconnection, $qSpiel);
									  $Spiel = mysqli_fetch_assoc($resSpiel);
									  $temp = "Name";
					
									  echo("<TD> $Spiel[$temp] </TD>");  
